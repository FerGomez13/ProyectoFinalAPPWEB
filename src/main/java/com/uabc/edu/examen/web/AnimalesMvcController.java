...
public class AnimalesMvcController {
    ...
    public String createAnimal(@RequestParam(value = "id", required = false) Optional<Long> id,
                               ...
                               @RequestParam(value = "nombre_adopcion", required = false, defaultValue = "N/A") String nombre_adopcion,
                               @RequestParam(value = "foto", required = false, defaultValue = "pencil.png") MultipartFile foto) {
